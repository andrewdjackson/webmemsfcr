...
export const AirTempFault = new Fault("inlet_air_temp_sensor_fault", "Inlet Air Temperature Sensor Fault", StatusFault);
...
export const IdleHotFault = new Fault("idle_hot_fault", "Hot Idle Fault", StatusFault);
export const IdleSpeedFault = new Fault("idle_speed_fault", "Idle Speed Control Fault", StatusFault);
...
export const JackFault = new Fault("iac_jack_fault", "ECU Reaching IAC Stepper Motor Limits (Jack Count High)", StatusFault);
export const CrankshaftFault = new Fault("crankshaft_position_sensor_fault", "Possible Crankshaft Position Sensor Fault", StatusFault);
export const CoilFault = new Fault("coil_fault", "Coil Timing High", StatusFault);
