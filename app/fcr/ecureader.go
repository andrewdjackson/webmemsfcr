...
func NewECUReader(connection string) ECUReader {
	...
	// if the os is darwin then override to use the loopback ecuReader as it is more reliable
	/*
...
func createResponseMap() map[string][]byte {
	...
	responseMap["D1"] = []byte{0xD1, 0x41, 0x42, 0x4E, 0x4D, 0x50, 0x30, 0x30, 0x32, 0x99, 0x00, 0x02, 0x03, 0x41, 0x42, 0x4E, 0x4D, 0x50, 0x30, 0x30, 0x32, 0x99, 0x00, 0x02, 0x03, 0x41, 0x42, 0x4E, 0x4D, 0x50, 0x30, 0x30, 0x32, 0x99, 0x00, 0x02, 0x03}
